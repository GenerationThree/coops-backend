package com.thoughtworks.coops.api.jersey;

import com.google.inject.AbstractModule;
import com.google.inject.Guice;
import com.google.inject.Injector;
import com.thoughtworks.coops.domain.user.EncryptionService;
import com.thoughtworks.coops.domain.user.UserRepository;
import com.thoughtworks.coops.infrastructure.records.Models;
import com.thoughtworks.coops.infrastructure.util.DefaultEncryptionService;
...
public class Api extends ResourceConfig {
    ...
    public Api(ServiceLocator locator) throws Exception {
        ...
        register(new AbstractBinder() {
            @Override
            protected void configure() {
                bind(com.thoughtworks.coops.infrastructure.repositories.MyBatisUserRepository.class).to(UserRepository.class);
